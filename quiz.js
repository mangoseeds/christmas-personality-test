const q = {
    ...
    7: {
        q: "바로 내일이 크리스마스 파티! 잠들기 전에",
        type: "SN",
        A: "내일 선물도 다 챙겼고, 알람도 맞췄고, 이제 푹 잠만 자면 된다!",
        B: "내일 파티에 누가 올까? 이런 일 있으면 재밌겠다.... (상상중)",
        c1: "#185033",
        c2: "#ca484a",
    },
    8: {
        q: "연말 파티에 친구와 나는 케이크 담당! 어디서 살지 심사숙고하여 고르는데",
        type: "SN",
    ...
    11: {
        q: "원래 가려던 케이크 가게에서 원하던 케이크를 사지 못한 것에 대해",
        type: "JP",
        A: "아무렇지 않으려고 해도 조금은 스트레스를 받는다",
        B: "이게 뭐 별건가!! 아무 생각 없이 넘길 수 있다",
        c1: "#af383c",
        c2: "#26cc68",
    },
    12: {
